          ...
          <div className="lg:col-span-7 text-left space-y-6">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4">
              <button
                ...
                className="px-8 py-4 rounded-xl bg-gradient-to-r from-[#1d4e9e] to-[#4f8eff] hover:from-[#4f8eff] hover:to-[#4f8eff]/80 text-white text-xs font-bold uppercase tracking-widest transition-all duration-300 shadow-lg shadow-[#4f8eff]/25 flex items-center justify-center space-x-2 group"
              >
              ...
              <button
                ...
                className="px-8 py-4 rounded-xl bg-[#0a0e1e] border border-slate-800 hover:border-slate-700 text-slate-300 text-xs font-bold uppercase tracking-widest transition-all duration-300 flex items-center justify-center"
              >
                View My Works
              </button>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 max-w-5xl mx-auto items-start">
            ...
            <div className="lg:col-span-5 space-y-6 text-left">
              {[
                { icon: <Mail className="w-5 h-5 text-white" />, title: "Location", val: "Dhaka-1333, Bangladesh" },
            ...
            <ul className="space-y-2 mb-6">
              {selectedProject.features.map((f, i) => (
                <li key={i} className="flex items-start text-slate-400 text-xs sm:text-sm">
                  <CheckCircle2 className="w-4.5 h-4.5 text-emerald-400 mr-2 flex-shrink-0" />
                  <span>{f}</span>
                </li>
              ))}
            </ul>
